...
-- ----------------------------
INSERT INTO `et_question` VALUES ('1', '驾驶机动车在道路上违', '{\"title\":\"驾驶机动车在道路上违反道路交通安全法的行为，属于什么行为？\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"违法行为\",\"B\":\"违章行为\",\"C\":\"违规行为\",\"D\":\"过失行为\"},\"choiceImgList\":{}}', '1', null, '0', null, '0', '2015-12-11 22:11:22', 'admin', '2015-12-11 23:03:54', 'A', '2', '1', '1', '1', '“违反道路交通安全法”，违反法律法规即为违法行为。官方已无违章/违规的说法。', '', '', '');
...
CREATE TABLE `et_user_training_history` (
  ...
  `start_time` timestamp NOT NULL DEFAULT '2015-12-11 23:03:54',
